...
- ![EC2 AMI Proof](snapshots/ec2_ami_selection.png)  
  *Amazon Linux 2023 AMI selected for instance launch.*

- ![EC2 Instance Type Proof](snapshots/ec2_instance_type.png)  
  *Instance type chosen for demo workload.*

- ![EC2 Storage Proof](snapshots/ec2_storage.png)  
  *Attached storage volumes confirmed.*

- ![EC2 Key Pair Proof](snapshots/ec2_keypair.png)  
  *Secure key pair setup for SSH access.*

- ![EC2 Security Group Proof](snapshots/ec2_security_group.png)  
  *Inbound rules configured for SSH and HTTP.*

- ![EC2 Name Tags Proof](snapshots/ec2_name_tags.png)  
  *Instance tagged for project tracking.*

- ![EC2 Summary Proof](snapshots/ec2_summary.png)  
  *Instance summary details verified.*

- ![EC2 Instance Proof](snapshots/ec2_instance.png)  
