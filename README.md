...
Each folder documents a different AWS service or capability, complete with banners, proof snapshots, and polished READMEs.  
...
### 🖥️ EC2 Setup Proof
![EC2 Setup Proof Banner](EC2-Setup-Proof/EC2-Setup-Proof.png)  
...
➡️ [View EC2 Setup Proof](EC2-Setup-Proof/README.md)
...
➡️ [View RDS Database Proof](RDS-Database-Proof/README.md)
...
➡️ [View Budget Proof AWS](BudgetProof-AWS/README.md)
...
➡️ [View Bedrock Model Demo](Bedrock-Model-Demo/README.md)

---

### 🌐 AWS Static Website Demo (S3)
![AWS Static Website Demo Banner](aws-static-website-demo/Images/aws_static_website_demo.png)  
...
➡️ [View Static Website Demo](aws-static-website-demo/README.md)
